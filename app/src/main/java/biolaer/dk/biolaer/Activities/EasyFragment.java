...
public class EasyFragment extends Fragment {
    ...
    private Button answerBtn1, answerBtn2, answerBtn3, answerBtn4, infoBtn1, infoBtn2, infoBtn3, infoBtn4;
    private TextView question_textView;
    private ImageView question_imageView;
    private MediaPlayer falseSound, correctSound;
    static Timer timer = new Timer();
    private static QuestionsActivity questionsActivity = new QuestionsActivity();
    ...
    //Metode som vælger spørgsmål fra den lette kategori i databasen.
    public void changeQuestionEasy() {
    ...
    //Metode som vælger spørgsmål fra de lette spørgsmål i databasen.
    public void changeQuestionHard() {
        final Question questionClass = new Question();
        questionClass.randomHardRef(mDatabaseX).addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
               ...
               //If sætninger som sætter det rigtige image ind alt efter det valgte spm.
                if (questionClass.getY() == 1){
                    question_imageView.setImageResource(R.drawable.elisa_spm1);
                }
                else if (questionClass.getY() == 2){
                    question_imageView.setImageResource(R.drawable.elisa_spm2);
                }
                else if (questionClass.getY() == 3){
                    question_imageView.setImageResource(R.drawable.elisa_spm3);
                }
